...
public class HelloController {
    ...
    //그런데 return 이 문자가 아니고 객체일 땐 기본이 JSON 방식으로 데이터를 http에 반환한다.
    ...
    //즉, 문자일 땐 HttpMessageConverter 의 JsonConverter, 정확히 말하면 MappingJackson2HttpMessageConverter 이 동작. (잭슨 라이브러리로 제이슨으로 바꿈. 잭슨이 기본 탑재되어있음.)
    //객체일 땐 HttpMessageConverter 의 StringHttpMessageConverter이 동작.
